...
def board_esp32cam(size: int = 180) -> str:
    return f"""<svg width="{size}" height="{int(size * 0.85)}" viewBox="0 0 220 187">
  <!-- PCB: blue, camera-board style -->
  <rect x="10" y="10" width="200" height="167" rx="6" fill="#1E3A5F" stroke="#0D2137" stroke-width="1.5"/>
  <!-- Camera module (OV2640) — large rectangle with lens -->
  <rect x="45" y="40" width="130" height="90" rx="4" fill="#222" stroke="#444" stroke-width="1.5"/>
  <rect x="50" y="45" width="120" height="80" rx="3" fill="#2A2A2A"/>
  <!-- Lens ring -->
  <circle cx="110" cy="85" r="32" fill="#111" stroke="#555" stroke-width="2"/>
  <circle cx="110" cy="85" r="24" fill="#1a1a2e" stroke="#333" stroke-width="1.5"/>
  <circle cx="110" cy="85" r="16" fill="#222" stroke="#444" stroke-width="1"/>
  <circle cx="110" cy="85" r="8" fill="#2a2a3e" opacity="0.5"/>
  <!-- Lens reflection -->
  <ellipse cx="103" cy="78" rx="4" ry="2" fill="white" opacity="0.08"/>
  <!-- Camera ribbon cable hint -->
  <rect x="80" y="130" width="60" height="6" rx="1" fill="#444" stroke="#333" stroke-width="0.5"/>
  <!-- ESP32 module (bottom-right) -->
  <rect x="25" y="20" width="70" height="18" rx="2" fill="#2A5A8A" stroke="#1E3A5F" stroke-width="0.8"/>
  <rect x="28" y="22" width="64" height="14" rx="2" fill="#C0C0C0" stroke="#999" stroke-width="0.8"/>
  <text x="60" y="33" font-size="6" fill="#333" text-anchor="middle" font-family="monospace">ESP32-S</text>
  <!-- PSRAM chip -->
  <rect x="155" y="22" width="30" height="14" rx="1.5" fill="#333" stroke="#555" stroke-width="0.5"/>
  <text x="170" y="32" font-size="5" fill="#AAA" text-anchor="middle" font-family="monospace">PSRAM</text>
  <!-- FTDI header pins (right edge, 2 rows) -->
  <g fill="#C0A030" opacity="0.55">
    <rect x="205" y="42" width="8" height="4" rx="1"/>
    <rect x="205" y="50" width="8" height="4" rx="1"/>
    <rect x="205" y="58" width="8" height="4" rx="1"/>
    <rect x="205" y="66" width="8" height="4" rx="1"/>
    <rect x="205" y="74" width="8" height="4" rx="1"/>
    <rect x="205" y="82" width="8" height="4" rx="1"/>
  </g>
  <!-- Bottom header pins -->
  <g fill="#C0A030" opacity="0.55">
    <rect x="20" y="170" width="4" height="8" rx="1"/>
    <rect x="28" y="170" width="4" height="8" rx="1"/>
    <rect x="36" y="170" width="4" height="8" rx="1"/>
    <rect x="44" y="170" width="4" height="8" rx="1"/>
    <rect x="52" y="170" width="4" height="8" rx="1"/>
    <rect x="60" y="170" width="4" height="8" rx="1"/>
    <rect x="68" y="170" width="4" height="8" rx="1"/>
    <rect x="76" y="170" width="4" height="8" rx="1"/>
    <rect x="84" y="170" width="4" height="8" rx="1"/>
    <rect x="92" y="170" width="4" height="8" rx="1"/>
    <rect x="100" y="170" width="4" height="8" rx="1"/>
    <rect x="108" y="170" width="4" height="8" rx="1"/>
    <rect x="116" y="170" width="4" height="8" rx="1"/>
    <rect x="124" y="170" width="4" height="8" rx="1"/>
    <rect x="132" y="170" width="4" height="8" rx="1"/>
    <rect x="140" y="170" width="4" height="8" rx="1"/>
    <rect x="148" y="170" width="4" height="8" rx="1"/>
    <rect x="156" y="170" width="4" height="8" rx="1"/>
    <rect x="164" y="170" width="4" height="8" rx="1"/>
    <rect x="172" y="170" width="4" height="8" rx="1"/>
    <rect x="180" y="170" width="4" height="8" rx="1"/>
    <rect x="188" y="170" width="4" height="8" rx="1"/>
    <rect x="196" y="170" width="4" height="8" rx="1"/>
  </g>
  <!-- Flash LED -->
  <circle cx="35" cy="145" r="5" fill="#FFFFAA" stroke="#CCCC44" stroke-width="0.8" opacity="0.9"/>
  <text x="35" y="135" font-size="5" fill="{_c('text_muted')}" text-anchor="middle">LED</text>
  <!-- Antenna trace -->
  <path d="M170 135 L190 135 L190 115" stroke="#C0A030" stroke-width="1.5" fill="none" opacity="0.4"/>
  <rect x="185" y="105" width="10" height="12" rx="1" fill="#0D2137" opacity="0.2"/>
  <!-- Reset button -->
  <circle cx="190" cy="155" r="5" fill="#888" stroke="#666" stroke-width="0.8"/>
  <text x="110" y="182" font-size="10" fill="{_c('text_muted')}" text-anchor="middle" font-family="sans-serif">ESP32-CAM AI Thinker</text>
</svg>"""
...
BOARD_ILLUSTRATIONS = {
    ...
    "ESP32-CAM AI Thinker": board_esp32cam,
