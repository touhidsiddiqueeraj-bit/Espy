...
class EasyOverlay(QWidget):
    ...
    def show_success(self, device_name: str, subtitle: str = ""):
        ...
        self._success_sub.setText(subtitle or f"{device_name} is running your code.")
    ...
    def _on_flash_done(self):
        ...
        if self._pending_path:
            ...
            self.set_mascot_mood("happy")
            self.waiting_for_device.emit()
        else:
            self.show_success("Your ESP32", "Your ESP32 is set up and ready to flash.")
