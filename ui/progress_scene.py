...
class ProgressScene(QWidget):
    ...
    flash_via_usb_requested = pyqtSignal(str)
    ...
    def __init__(self):
        ...
        self._flash_usb_btn = QPushButton("Flash via USB")
    ...
    def _build_ui(self):
        ...
        self._flash_usb_btn.setObjectName("secondary")
        self._flash_usb_btn.clicked.connect(self._on_flash_usb)
        self._flash_usb_btn.hide()
        action_row.addWidget(self._flash_usb_btn)
    ...
    def show_success(self, device_name: str, subtitle: str = ""):
        self._state = "done"
        ...
        self._status.setText(subtitle or f"{device_name} is running your code.")
    ...
    def show_compilation_ready(self, bin_path: str, has_device: bool,
        ...
        self._flash_usb_btn.setVisible(has_usb)
    ...
    def _on_flash_usb(self):
        if self._bin_path:
            self.flash_via_usb_requested.emit(self._bin_path)
