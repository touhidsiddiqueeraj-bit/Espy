...
BOARD_ALIASES: dict[str, str] = {
    ...
    "AI Thinker": "ESP32-CAM AI Thinker",
    "AI-THINKER": "ESP32-CAM AI Thinker",
...
def parse_ino(path: str) -> InoConfig:
    ...
    # Content-based board detection for ESP32-CAM / AI-Thinker
    if not cfg.board or cfg.board == "ESP32 Dev Module":
        cam_pats = [r'ai.?thinker', r'esp32.?cam', r'camera_model_ai_thinker']
        for pat in cam_pats:
            if re.search(pat, content, re.IGNORECASE):
                cfg.board = "ESP32-CAM AI Thinker"
                break
